...
class UNetModel(nn.Module):
    def __init__(self,
                img_backbone: str = 'unconditioned',
...
# m = UNetModel(with_attention=False, verbose=True, img_backbone='unconditioned', image_condition_dim=1024)
