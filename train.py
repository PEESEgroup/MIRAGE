...
from model.data_loader import MaizeDataLoader
...
def main(opt):
    ...
    val_data = data_loader.dataloader(train=False)
    ...
    # logging.basicConfig(
    #     filename=os.path.join(config['logging']['save_dir'], 'training.log'),
    #     level=logging.INFO,
