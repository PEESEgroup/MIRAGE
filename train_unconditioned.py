...
from model.model_trainer_uncond import DiffusionModel
from model.data_loader import UnconditionalMaizeDataLoader
...
def main(opt):
    ...
    data_loader = UnconditionalMaizeDataLoader(
    ...
    train_data = data_loader.dataloader(train=True)
    ...
    wandb_logger = WandbLogger(project="Maize")
...
if __name__ == '__main__':
    ...
    parse.add_argument('--config', type=str, default='unconditioned.yaml')
